...
Your Strata license is not an environment variable — you enter it on the setup screen the
first time you open the app, or later under **Settings → License**.
...
See [Performance and scaling](/self-hosting/performance-scaling) for connection budgeting and load tests.
