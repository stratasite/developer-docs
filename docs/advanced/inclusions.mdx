...
Inclusions solve a critical problem: **computing correct averages and medians when counts per group are uneven**. They force calculations at a finer grain (by including extra dimensions) before rolling up to the final result. This is the opposite direction to [exclusions](/developer-guide/advanced/exclusions), which remove dimensions from calculations.
...
- Learn about [exclusions](/developer-guide/advanced/exclusions)
- Explore [snapshot measures](/developer-guide/semantic-model/fields/measures/snapshot)
- Read about [window decorators](/developer-guide/advanced/decorators/window)
