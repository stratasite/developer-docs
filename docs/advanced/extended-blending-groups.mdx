...
For the basic YAML setup, see [Extended blending](/developer-guide/semantic-model/expressions/extended-blending).
...
Blending does not replace [relationships](/developer-guide/semantic-model/relationships/cardinality). Tables still need proper `one_to_many`, `many_to_one`, or `one_to_one` relationships. Extended blend groups tell the planner how to treat dimensions that live in different tables as one for grouping and filtering when paths exist.

## Next Steps

- [Extended blending](/developer-guide/semantic-model/expressions/extended-blending) — YAML and `extended_blend_group` on dimensions
- [Dimensions](/developer-guide/semantic-model/fields/dimensions)
- [Relationships](/developer-guide/semantic-model/relationships/cardinality)
