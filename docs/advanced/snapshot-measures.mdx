...
1. **Set snapshot_date** - Required on table
2. **Use descriptive names** - "Ending Inventory" not "Inventory"
3. **Document purpose** - Add descriptions explaining snapshot behavior
4. **Test queries** - Verify snapshot behavior works correctly

## Next Steps

- Learn about [exclusions](/docs/advanced/exclusions)
- Explore [inclusions](/docs/advanced/inclusions)
- Read about [temporal decorators](/docs/advanced/decorators/temporal)
