...
- Learn about [cost optimization](/developer-guide/advanced/cost-optimization)
- Explore [partitions](/developer-guide/advanced/partitions)
- Read about [datasources](/developer-guide/semantic-model/datasources)
