...
2. **Format as percentage** - Use `formatter: percent` for measures
3. **Document measures** - Help users understand contribution options

## Next Steps

- Learn about [temporal decorators](/developer-guide/advanced/decorators/temporal)
- Explore [window decorators](/developer-guide/advanced/decorators/window)
- Read about [snapshot measures](/developer-guide/semantic-model/fields/measures/snapshot)
