...
- [Semantic Routing](/developer-guide/advanced/semantic-routing) — How queries select datasources
- [Cost Optimization](/developer-guide/advanced/cost-optimization) — Tuning table and join costs
