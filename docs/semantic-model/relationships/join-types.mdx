...
- Learn about [cardinality](/semantic-model/relationships/cardinality)
- Read the [relationships guide](/cli/relationships)
- Explore [relationship schema reference](/semantic-model/relationships/cardinality)
