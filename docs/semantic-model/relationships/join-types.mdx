...
- Learn about [cardinality](/developer-guide/semantic-model/relationships/cardinality)
- Read the [relationships guide](/developer-guide/cli/relationships)
- Explore [relationship schema reference](/developer-guide/semantic-model/relationships/cardinality)
