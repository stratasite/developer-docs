...
For CLI commands to add, test, and manage datasources, see [Managing Datasources](/developer-guide/cli/datasources).
...
1. **PostgreSQL** — [postgres](/developer-guide/semantic-model/adapters/postgres)
2. **Snowflake** — [snowflake](/developer-guide/semantic-model/adapters/snowflake)
3. **MySQL** — [mysql](/developer-guide/semantic-model/adapters/mysql)
4. **SQL Server** — [sqlserver](/developer-guide/semantic-model/adapters/sqlserver)
5. **Athena** — [athena](/developer-guide/semantic-model/adapters/athena)
6. **Trino** — [trino](/developer-guide/semantic-model/adapters/trino)
7. **DuckDB** — [duckdb](/developer-guide/semantic-model/adapters/duckdb)
8. **Druid** — [druid](/developer-guide/semantic-model/adapters/druid)
...
- Universes and query plans are built per datasource, then optionally merged at the result level (see [Multi-Datasource](/developer-guide/advanced/multi-datasource)).
...
- [Managing Datasources](/developer-guide/cli/datasources) — CLI commands
...
- [cost-optimization](/developer-guide/advanced/cost-optimization)
