...
The data type of the dimension. See [data types reference](/docs/semantic-model/fields/data-types).
...
For date/date_time dimensions, specify supported granularities.
...
[Learn about date grains →](/docs/semantic-model/fields/data-types#date-and-datetime)
...
4. **Set grains for dates** - Enable flexible date grouping
