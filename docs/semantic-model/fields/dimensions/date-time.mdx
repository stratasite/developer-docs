...
- Use [field format](/developer-guide/semantic-model/fields/formatters) for display (e.g. `date:short`, custom `pattern`).
...
- [Data types](/developer-guide/semantic-model/fields/data-types#date-and-datetime-grains)
