...
- Learn about [dimensions](/developer-guide/semantic-model/fields/dimensions)
- Learn about [measures](/developer-guide/semantic-model/fields/measures)
- Explore [data types](/developer-guide/semantic-model/fields/data-types)
- Read about [display types](/developer-guide/semantic-model/fields/dimensions#display_type)
- Run [strata audit](/developer-guide/cli/audit) before deploy
