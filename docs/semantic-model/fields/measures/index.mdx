...
- **[Compound measures](/semantic-model/fields/measures/compound)** — Expressions that reference other measures (e.g. `[Total Revenue] - [Total Cost]`)
- **[Snapshot measures](/semantic-model/fields/measures/snapshot)** — Point-in-time values (`beginning` or `ending` of a period)
...
Typically `decimal` or `integer`. See [data types](/semantic-model/fields/data-types).
...
Apply formatting. [Formatters →](/semantic-model/fields/formatters)
...
For point-in-time measures: `ending` or `beginning`. Table must have `snapshot_date`. [Snapshot measures →](/semantic-model/fields/measures/snapshot)

### exclusion_type / exclusions

Exclude certain dimensions. [Exclusions →](/advanced/exclusions)

### inclusions

Force calculation at a lower level before rolling up. [Inclusions →](/advanced/inclusions)
...
For ratios that reference other **measures** by name, use [compound measures](/semantic-model/fields/measures/compound).
...
- [Compound measures](/semantic-model/fields/measures/compound) - Expressions referencing other measures
- [Snapshot measures](/semantic-model/fields/measures/snapshot) - Point-in-time values
- [Dimensions](/semantic-model/fields/dimensions)
- [Data types](/semantic-model/fields/data-types)
- [Formatters](/semantic-model/fields/formatters)
- [Expressions](/semantic-model/expressions/sql)
