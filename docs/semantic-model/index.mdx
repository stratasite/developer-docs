...
[Learn about tables →](/developer-guide/semantic-model/tables)
...
[Learn about fields →](/developer-guide/semantic-model/fields/dimensions)
...
[Learn about relationships →](/developer-guide/semantic-model/relationships/cardinality)
...
[Advanced features →](/developer-guide/advanced)

## Next Steps

- Read about [tables](/developer-guide/semantic-model/tables)
- Explore [dimensions](/developer-guide/semantic-model/fields/dimensions) and [measures](/developer-guide/semantic-model/fields/measures)
- Learn about [expressions](/developer-guide/semantic-model/expressions/sql)
- Understand [relationships](/developer-guide/semantic-model/relationships/cardinality)
- Go deeper in [Advanced](/developer-guide/advanced)
