...
Control how values are displayed using the `format` property (shortcut string or hash). See [Field format](/developer-guide/semantic-model/fields/formatters) for types, shortcuts, and defaults.
...
- Learn about [expressions](/developer-guide/semantic-model/expressions) (SQL, lookups, arrays)
- Read the [dimensions deep-dive](/developer-guide/semantic-model/fields/dimensions)
- Read the [measures deep-dive](/developer-guide/semantic-model/fields/measures)
- Explore [data types reference](/developer-guide/semantic-model/fields/data-types)
