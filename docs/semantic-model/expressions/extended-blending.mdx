...
For how blend groups affect query planning, path formation, and multi-table scenarios, see [Extended blending groups](/developer-guide/advanced/extended-blending-groups).

## Next Steps

- [Dimensions](/developer-guide/semantic-model/fields/dimensions) — `extended_blend_group` is set on dimensions
- [Extended blending groups](/developer-guide/advanced/extended-blending-groups) — Use cases and behavior in depth
