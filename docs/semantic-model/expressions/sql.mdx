...
- Learn about [lookup expressions](/developer-guide/semantic-model/expressions/lookups)
- Explore [array expressions](/developer-guide/semantic-model/expressions/arrays)
- Understand [primary keys](/developer-guide/semantic-model/fields/dimensions#primary-keys)
