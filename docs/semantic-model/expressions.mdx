...
- Learn about [relationships](/developer-guide/cli/relationships) to join tables
- Read the [SQL expressions deep-dive](/developer-guide/semantic-model/expressions/sql)
- Explore [lookup expressions](/developer-guide/semantic-model/expressions/lookups)
- Understand [array expressions](/developer-guide/semantic-model/expressions/arrays)
