...
A **table** model (`tbl.*.yml`) wraps a physical database table with semantic fields (dimensions and measures). See [Tables](/docs/semantic-model/tables) and [Creating tables](/docs/cli/tables).
