...
- Learn how to [create tables](/docs/guides/creating-tables)
- Understand [field types and expressions](/docs/guides/fields-and-types)
- Explore [relationships](/docs/guides/relationships)
