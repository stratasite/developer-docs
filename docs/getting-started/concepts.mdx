...
- Joins between tables respect their true cardinality (see [Cardinality](/developer-guide/semantic-model/relationships/cardinality)).
...
- [Key terms and when to use what](/developer-guide/getting-started/glossary) — Glossary and decision guide
- Learn how to [create tables](/developer-guide/cli/tables)
- Understand [field types and expressions](/developer-guide/semantic-model/fields-and-types)
- Explore [relationships](/developer-guide/cli/relationships)
- Read about [universe formation](/developer-guide/advanced/universe-formation) and [advanced features](/developer-guide/advanced)
