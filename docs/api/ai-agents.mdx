...
For programmatic access to deployed semantic layers — metadata discovery and query execution — see the [REST API v1](/developer-guide/api/rest/) documentation.
