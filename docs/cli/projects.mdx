...
The CLI also initializes a git repository and makes an initial commit of these files. `AGENTS.md` is committed with them — it is what lets a coding agent build the semantic model for you. See [Building Your Model](/developer-guide/cli/building-your-model).
...
- [Managing Datasources](/developer-guide/cli/datasources) - Add and configure datasources
- [Building Your Model](/developer-guide/cli/building-your-model) - Author models yourself or with a coding agent
- [Creating Tables](/developer-guide/cli/tables) - Create semantic table models
- [Deployment](/developer-guide/cli/deployment) - Deploy to the Strata server
