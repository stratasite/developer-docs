...
**Check:** Required keys in table and relationship files. See [Tables](/developer-guide/semantic-model/tables) and [Relationships](/developer-guide/semantic-model/relationships/cardinality).
...
- [Deployment](/developer-guide/cli/deployment) - Deploy after audits pass
- [Testing](/developer-guide/cli/tests) - Validate SQL generation
- [CI/CD](/developer-guide/cli/ci-cd) - Automate audits and deployment
