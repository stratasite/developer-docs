...
- Learn about [cardinality types](/developer-guide/semantic-model/relationships/cardinality) in detail
- Understand [join types](/developer-guide/semantic-model/relationships/join-types)
- [Cardinality and join types](/developer-guide/semantic-model/relationships/cardinality)
- Explore [advanced features](/developer-guide/advanced) like multi-datasource queries
