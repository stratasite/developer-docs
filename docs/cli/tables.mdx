...
**Partitions**: Optional data availability constraints (see [Partitions guide](/advanced/partitions))
...
- Learn about [field types and expressions](/semantic-model/fields-and-types)
- Set up [relationships](/cli/relationships) between tables
- Configure [datasources](/semantic-model/datasources) for multiple databases
- Read the [table schema reference](/semantic-model/tables) for all options
