...
:::tip
Modeling a whole schema at once? A coding agent can author these files from the project's `AGENTS.md` instead. See [Building Your Model](/developer-guide/cli/building-your-model).
:::
...
**Partitions**: Optional data availability constraints (see [Partitions guide](/developer-guide/advanced/partitions))
...
- Learn about [field types and expressions](/developer-guide/semantic-model/fields-and-types)
- Set up [relationships](/developer-guide/cli/relationships) between tables
- Configure [datasources](/developer-guide/semantic-model/datasources) for multiple databases
- Read the [table schema reference](/developer-guide/semantic-model/tables) for all options
- Compare both authoring paths in [Building Your Model](/developer-guide/cli/building-your-model)
