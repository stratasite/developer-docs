...
- You are responsible for providing:
  ...
  - Object storage (S3-compatible or GCS) if you use features that store files or exports.
...
For automated deployments, see the [CI/CD guide](/developer-guide/cli/ci-cd).

## Next Steps

- Learn about [CI/CD workflows](/developer-guide/cli/ci-cd)
- Read about [testing](/developer-guide/cli/tests)
- Explore [audit commands](/developer-guide/cli/audit)
