...
- The Strata server itself runs in a container (for example, Docker or Kubernetes) and hosts the Rails application and API only.
...
For automated deployments, see the [CI/CD guide](/cli/ci-cd).

## Next Steps

- Learn about [CI/CD workflows](/cli/ci-cd)
- Read about [testing](/cli/tests)
- Explore [audit commands](/cli/audit)
