...
Use [temporal decorators](/developer-guide/advanced/decorators/temporal) for comparisons:
...
- [Temporal Decorators](/developer-guide/advanced/decorators/temporal) — YoY and MoM comparisons
- [Window Decorators](/developer-guide/advanced/decorators/window) — Running totals, moving averages
- [Contribution Decorators](/developer-guide/advanced/decorators/contribution) — % of total analysis
