...
**Fix:** Verify the IAM user or role behind your datasource credentials has the necessary permissions. See adapter-specific docs for required permissions (e.g., [Athena](/developer-guide/semantic-model/adapters/athena#authentication)).
...
- [Deployment Guide](/developer-guide/cli/deployment)
- [Audit Commands](/developer-guide/cli/audit)
- [Datasource Configuration](/developer-guide/semantic-model/datasources)
