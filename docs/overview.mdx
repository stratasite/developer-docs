...
- **Programmatic access**: [REST API v1](/developer-guide/api/rest/) for metadata discovery and query execution

## Your Journey

To begin working with Strata, follow these steps:

1. **[Install Strata CLI](/developer-guide/getting-started/installation)** — Install the command-line tool on your system
2. **[Core Concepts](/developer-guide/getting-started/concepts)** — Understand semantic layer, tables, relationships, and datasources before you build
3. **[Quickstart](/developer-guide/getting-started/quickstart)** — Build your first semantic model step-by-step (assumes you've read concepts)
...
Ready to get started? [Install Strata CLI](/developer-guide/getting-started/installation), then read [Core Concepts](/developer-guide/getting-started/concepts) and run the [Quickstart](/developer-guide/getting-started/quickstart) to create your first semantic model.

To query a deployed semantic layer programmatically, see the [REST API](/developer-guide/api/rest/) guide and [API quickstart](/developer-guide/api/rest/quickstart).
