...
- API key configured (in `.strata` file)
...
For automated deployments, see the [CI/CD guide](/docs/guides/ci-cd).

## Next Steps

- Learn about [CI/CD workflows](/docs/guides/ci-cd)
- Read about [testing](/docs/guides/testing)
- Explore [audit commands](/docs/reference/cli/audit)
