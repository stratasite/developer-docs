...
- Learn about [field types and expressions](/docs/guides/fields-and-types)
- Set up [relationships](/docs/guides/relationships) between tables
- Configure [datasources](/docs/guides/datasources) for multiple databases
- Read the [table schema reference](/docs/reference/schema/table) for all options
